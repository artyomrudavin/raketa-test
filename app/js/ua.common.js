...
$(function() {
	...
	$(litreVl).on('click', function (e) {
		...
		if ( bakVal.hasClass('active') ) {
			...
			if ( dataTk == 'twentyTk' ) {
				...
				mtextValue.text('Самогонний аппарат з баком на 20л');
				hiddenComment.val('Самогонний аппарат з баком на 20л');
			} else if ( dataTk == 'thirtyTk' ) {
				formOld.text('7 150₴');
				...
				mtextValue.text('Самогонний апарат з баком на 30л');
				hiddenComment.val('Самогонний апарат з баком на 30л');
			} else if ( dataTk == 'fiftyTk' ) {
				formOld.text('7 650₴');
	...
	$(colVal).on('click', function(e) {
		...
		if ( colVal.hasClass('active') ) {
			...
			mtextValue.text('Самогонний апарат з баком на 20л');
			hiddenComment.val('Самогонний апарат з баком на 20л');
			$(litreVl).removeClass('active');
